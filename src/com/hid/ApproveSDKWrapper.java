	...
	*/
	...
	public String retriveTransaction(String txId, Context appContext, FragmentActivity activity, String password,
		...
		try {
			...
			callback.execute(new Object[] { ApproveSDKConstants.HID_SUCCESS_MESSAGE, ApproveSDKConstants.NO_EXCEPTION, jsonObj });
		} catch (InternalException e) {
			e.printStackTrace();
			...
			e.printStackTrace();
			callback.execute(new Object[] { ApproveSDKConstants.HID_ERROR_MESSAGE, ApproveSDKConstants.GENERIC_EXCEPTION, e.getMessage() });
		...
		try {
			...
			if (isBiometricEnabled) {
				...
				try {
					...
					genericExecuteCallback(new Object[] { ApproveSDKConstants.HID_ERROR_MESSAGE, ApproveSDKConstants.BIOMETRIC_ERROR,
							ApproveSDKConstants.HID_BIOMETRIC_ERROR_CODE }, callback);
